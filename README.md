...
Note that these projects are just POC-level code to explore the capabilities and limitations of agentic systems and modern AI tooling for product and analytics work. 

The most recent was an autonomous coding orchestration system to circumvent key failures with LLMs and agentic systems (in a private repo). At a high level, it is a three-layer system that takes a high-level plan and autonomously ships it, handling task execution, multi-model adversarial code review, among other items.
...
An automated daily briefing system that delivers personalized AI insights every weekday at 9:30 AM ET. It curates AI articles, summarizes podcasts, and processes newsletters into a single digestible morning update.
...
This helps overcome trust issues with current deep research agents that often prioritize coverage. I sometimes use it when doing research for new product features or higher-level planning.
