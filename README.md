...
These projects towards the bottom were how I learned where models and agentic systems actually break: taking shortcuts, optimism bias, context drift, silent failures, and lack of continual learning, among others.
...
The end goal is an extensive system that mostly improves itself, where I handle the upfront planning and code review to ensure it scales, and the system handles the rest.
